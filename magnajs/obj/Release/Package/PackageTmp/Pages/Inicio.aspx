                ...
                <div class="modal-content" ng-form="notasForma">
                    ...
                    <div class="modal-body" ng-class="{'submitted': submitted}">
                        <table width="100%">
                            ...
                            <tr>
                                <td width="20%"><%= this.GetMessage("lblEvidencias") %></td>
                                <td width="20%" style="padding: 10px 0px 0px 5px; font-weight: 600;">
                                    <ex-fileupload ng-model="vm.item.na_campo" image-button="fa-upload" ng-if="((vm.usuario.Loggeado && vm.usuario.EsAprobador && vm.item.na_campo != null) || (vm.usuario.Loggeado && vm.usuario.EsCaptura))"
                                        download-button="fa-paperclip" on-success="setParametrosArchivo(response, vm.item, 2)"
                                        options="fileOptionsDetalle" parameters="fileParameters" open-file="openDocumento(vm.item, 2)">
                                    </ex-fileupload>
                                </td>
                                <td width="60%">{{vm.item.na_campo}}</td>
                            </tr>
                            <tr>
